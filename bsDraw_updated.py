...
if config.get('paths', 'methylmapper'):
    import meMapper as meMapp
        ...
        for contig in unpack(
            ...
            if a.Omelet:
                ...
                if config.get('exists', 'PIL').lower() == 'true':
                    ...
                    raise IOError('Called -Omelet but PIL is False')
